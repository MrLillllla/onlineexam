...
class Question(models.Model):
    ...
    optionA=models.CharField('A选项',max_length=100)
    optionB=models.CharField('B选项',max_length=100)
    optionC=models.CharField('C选项',max_length=100)
    optionD=models.CharField('D选项',max_length=100)
